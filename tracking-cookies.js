...
/*!
 * JavaScript tracking v1.0.1
 * https://github.com/Ye-Ting/daovoice-tracking-conversions
 *
 * Copyright 2017 Ye-Ting  
 * Released under the MIT license
 */
...
if (getParameterByName('utm_medium') !== "") { 
  Cookies.set('utm_medium', getParameterByName('utm_medium')); 
}
if (getParameterByName('utm_term') !== "") { 
  Cookies.set('utm_term', getParameterByName('utm_term')); 
}
if (getParameterByName('utm_content') !== "") { 
  Cookies.set('utm_content', getParameterByName('utm_content')); 
}
if (getParameterByName('utm_campaign') !== "") { 
  Cookies.set('utm_campaign', getParameterByName('utm_campaign')); 
}
